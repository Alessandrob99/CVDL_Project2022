...
parser.add_argument('--class_embedding_type', default='')
...
for epoch in range(opt.nepoch):
	...
	print('[%d/%d] Loss_D: %.4f Loss_G: %.4f, Wasserstein_dist: %.4f, c_errG:%.4f'
			% (epoch, opt.nepoch, D_cost.data, G_cost.data, Wasserstein_D.data, c_errG.data))#, criticD_real.data, criticD_fake.data))
